...
const tooltipBaseClasses = cva(
  'bg-gray-50 text-gray-900 absolute outline top-full w-full whitespace-normal z-900 mb-2 hidden px-2 py-4 text-xs group-focus-within:block group-hover:block',
  {
    variants: {
      variant: {
...
const tooltipWrapperBaseClasses = cva('group relative h-full w-full', {
  variants: {
    ...
    withOutline: {
      true: 'focus-within:outline hover:outline hover:z-900 focus-within:z-900',
      false: '',
    },
  },
  defaultVariants: {
